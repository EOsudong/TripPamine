  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="block bg-white rounded-2xl border border-dashed border-slate-200 p-6 opacity-60">
          <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-2">퀘스트 관리 (준비 중)</p>
          <p className="text-sm text-slate-400">추후 추가될 예정이에요.</p>
        </div>
      </div>
    </AdminLayout>
  )
