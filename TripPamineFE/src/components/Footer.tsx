  ...
  return (
    <footer className="bg-slate-900 text-slate-400 py-12 px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
        ...
        {[
          { title: "여행 서비스", items: ["국내 패키지", "당일치기", "1박 2일", "가족 여행", "커플 여행"] },
          { title: "고객 지원", items: ["예약 확인", "취소/환불 정책", "자주 묻는 질문", "1:1 문의", "공지사항"] },
          { title: "회사 정보", items: ["회사 소개", "이용 약관", "개인정보 처리방침", "여행 블로그", "파트너십"] },
        ].map((col) => (
          <div key={col.title}>
